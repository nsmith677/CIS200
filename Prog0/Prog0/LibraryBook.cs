...
public class LibraryBook
{
    ...
    public string Title
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Enter valid title");
            }
            else
            {
                _title = value;
    ...
    public int CopyrightYear
    {
        ...
        set
        {
            if (value >= 0)
                ...
                throw new ArgumentOutOfRangeException("Enter valid year");
        }
    }
    ...
    public string CallNumber
    {
        ...
        set
        {
            if (value == null || value == string.Empty)
            {
                throw new ArgumentOutOfRangeException("Enter valid call number");
            }
            else
            {
                _callNumber = value;
    ...
    //Precondition: The book is checked out
